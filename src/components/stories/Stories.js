                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            ...
                            <div className='mobile'>
                                ...
                                <img data-aos="zoom-in" data-aos-duration="800" data-aos-easing="ease-in-out" className="w-100" style={{ marginBottom: '20px' }} src="./assets/images/stories/stories1.png" alt="" />
                                <Row>
                                    <Col xs={6}>
                                    <img className='w-100' style={{height:"50vw"}} data-aos="zoom-in" data-aos-delay="1200" data-aos-duration="800" data-aos-easing="ease-in-out" src="./assets/images/stories/stories4.png" alt="" />
                                    </Col>
                                    <Col xs={6}>
                                    <img className='w-100' style={{height:"50vw"}} data-aos="zoom-in" data-aos-delay="1400" data-aos-duration="800" data-aos-easing="ease-in-out" src="./assets/images/stories/stories3.png" alt="" />
                                    </Col>
                                </Row>
