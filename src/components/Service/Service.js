        ...
        <div id="service" className={style.servicemain}>
            ...
            <Row>
                ...
                <Col xs={12} lg={{span:5,offset:1}}>
                    <div className="desktop">
                    <Heading w="100%" padding="30px 0 0 15px" textalign="left" text="Our Service"/>

                    <div className={style.listofitems}>
                        <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="200" className={style.singleitem}>
                            <img src="./assets/images/services/sericon1.png" alt=""/>
                            <h4>University Selection</h4>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="400" className={style.singleitem}>
                            <img src="./assets/images/services/sericon2.png" alt=""/>
                            <h4>Application Assistance</h4>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="600" className={style.singleitem}>
                            <img src="./assets/images/services/sericon3.png" alt=""/>
                            <h4>Visa Guidance</h4>
                        </div>
                        <div data-aos="fade-left" data-aos-duration="800" data-aos-delay="800" className={style.singleitem}>
